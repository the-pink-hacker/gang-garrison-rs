...
impl Default for ClientConfigControls {
    fn default() -> Self {
        Self {
            ...
            fire: vec![MouseButton::Left.into(), Button::RightTrigger2.into()].into(),
            special: vec![MouseButton::Right.into(), Button::LeftTrigger.into()].into(),
            taunt: vec![KeyCode::KeyF.into(), Button::LeftThumb.into()].into(),
            call_healer: vec![KeyCode::KeyE.into(), Button::RightTrigger.into()].into(),
            ...
            debug_menu: vec![KeyCode::F3.into(), Button::Mode.into()].into(),
            menu: vec![KeyCode::Escape.into(), Button::Start.into()].into(),
            show_scores: vec![KeyCode::ShiftLeft.into(), Button::Select.into()].into(),
